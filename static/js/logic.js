...
      else if (magnitude < 8) {return "#654321"}      //  countdown brown 
      else if (magnitude < 9) {return "#220000"}      //  custom dark brown
...
// MAP IS RE-CENTERED TO VIEW THE EARTHQUAKE THIS MORNING NEAR JAMAICA
...
    L.geoJSON(data, {
      style: function() {
        return {color: "#60D", weight: 1.5, fillOpacity: 0}
      }
    }).addTo(faultLines)
  })
